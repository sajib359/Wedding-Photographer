    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12  rounded-2xl p-5">
        <div className="w-full shadow-xl">
          ...
          <img
            src="https://blog.miniorange.com/wp-content/uploads/sites/19/2021/11/authentication-vs-authorization.webp"
            alt=""
          />
        ...
        <div>
          ...
          <img
            src="https://areknawo.com/content/images/2020/08/cover-1.png"
            alt=""
          />
          ...
          <p>
            ...
            exactly who is accessing their information or site. Authentication
            is used by a client when the client needs to know that the server is
            system it claims to be. In authentication, the user or computer has
            to prove its identity to the server or client. Usually,
            ...
            scans, voice recognition, and fingerprints. Authentication by a
            client usually involves the server giving a certificate to the
            client in which a trusted third party such as Verisign or Thawte
            states that the server belongs to the entity (such as a bank) that
            the client expects it to
          </p>
        </div>
        ...
        <div>
          ...
          <img
            src="https://bs-uploads.toptal.io/blackfish-uploads/components/blog_post_page/content/cover_image_file/cover_image/885818/regular_800x320_staging.toptal.net_firebase_role-based-firebase-authentication-826a632143cf2f34949096059f93cff1.png"
            alt=""
          />

          <h3 className="text-2xl font-bold mt-5">
            {" "}
            firebase provide services other than authentication:{" "}
          </h3>
          <p>
            Firebase, developers don’t need to worry about the backend
